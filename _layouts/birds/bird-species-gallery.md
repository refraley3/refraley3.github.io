...
Lens: Lens Model  
Settings: ISO ___ • Aperture f/__ • Shutter 1/___ s  
IMAGE5 • Size: ____x____  
{:.caption}

Follow with one or two short paragraphs if the image needs interpretation or transition.
...
Conclude with a short paragraph drawing together the contrast between forms, behavior, or visibility in the habitat.
