...
The **Common Greenshield Lichen** (*Flavoparmelia caperata*) forms wide, cohesive mats across bark, its lobes thick, smooth, and gently uplifted along the edges. **Greenshield in Winter Light** highlights the species’ characteristic **pale green thallus**, dusted with fine pseudocyphellae and edged by rounded margins that curl just enough to reveal a **dark brown, rhizine-lined underside**. Unlike crustose lichens that sit flush against the substrate, Greenshield develops **loose, leafy lobes** that subtly shift with humidity and seasonal moisture.

![Greenshield in Winter Light](/gallery/fungi/lichen/assets/common-greenshield/E21A8093-8107.jpg){: .cover role="img" aria-label="Greenshield in Winter Light"}
**Greenshield in Winter Light**  
_Broad, softly wrinkled lobes holding fast to the bark, their pale green surface brightened by cold air and angled sunlight._  
...
The **Greenshield Circle** image shows a near-perfect foliose rosette centered on deeply fissured elm bark, bordered by bright crustose yellows and scattered gray foliose thalli. Its matte surface and calm green tone create a natural focal point against the dark, rugged background.
...
**Greenshield Circle**  
_A rounded foliose colony anchored firmly to aging elm bark._  
Camera: Canon EOS 5D Mk IV  
Lens: EF100mm f/2.8L Macro IS USM  
...
In **Twin Colonies**, two mature rosettes appear on opposite sides of the elm trunk, illustrating how *F. caperata* forms **self-contained disks** rather than spreading continuously. Bright crustose yellows and darker foliose neighbors heighten the Greenshield’s cool, mint-green contrast.

![Twin Colonies](/gallery/fungi/lichen/assets/common-greenshield/E21A6518.jpg){: .cover role="img" aria-label="Twin Colonies"}
**Twin Colonies**  
_Two established foliose rosettes on elm bark in a mixed hardwood forest._  
Camera: Canon EOS 5D Mk IV  
Lens: EF24–70mm f/2.8L II USM  
Settings: ISO 800 • Aperture f/13.0 • Shutter 1/4 s  
E21A6518 • Size: 6649×4432  
{: .caption}
...
Observed in a **mixed hardwood stand** containing elm, oak, and maple. Light shade and steady humidity provide ideal conditions. In cool fall weather, Greenshield retains crisp texture, while neighboring Sunburst and Candleflame lichens intensify in color, sharpening the contrast across the bark.

---

## Fun Fact

*Flavoparmelia caperata* produces **caperatic acid**, a long-lasting defensive compound that protects it from microbes and UV radiation — a key factor in its ability to persist for decades on the same trunk.
...
![Greenshield Circle](/gallery/fungi/lichen/assets/common-greenshield/E21A6505.jpg){: .cover role="img" aria-label="Greenshield Circle" style="width: 400px;"}
_E21A6505_ **Greenshield Circle**
...
- **Common Greenshield Lichen — Missouri Department of Conservation**  
  <https://mdc.mo.gov/discover-nature/field-guide/common-greenshield-lichen>

- **Flavoparmelia caperata — iNaturalist Taxon Page**  
  <https://www.inaturalist.org/taxa/129848-Flavoparmelia-caperata>

- **Common Greenshield Lichen (Flavoparmelia caperata) - Minnesota Seasons.com**  
