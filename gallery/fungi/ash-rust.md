...
layout: photo
title: Ash Rust
description: Gallery images of *Puccinia sparganioides* (Ash Rust), photographed in Minnesota woodland understory.
tags: [fungi, Puccinia sparganioides, ash-rust, rust fungus, fungus photography]
---

## [*Puccinia sparganioides*](/field-notes/fungi/puccinia-sparganioides/)  
{: .taxonomy-last}

Ash Rust appears as bright orange clusters scattered across the surface of young ash
leaves, often forming dense patches of tiny cup-like structures. When the infection is
heavy, the leaf may curl or distort around the growing rust, turning the underside into a
textured field of orange spores. In early summer woodland light the color can be striking
— a vivid contrast against the soft green of new leaves and the darker blur of the forest
behind.

For identification details and comparison with other similar species, see the [*Puccinia sparganioides*](/field-notes/fungi/puccinia-sparganioides/) in the **Field Notes** section.
