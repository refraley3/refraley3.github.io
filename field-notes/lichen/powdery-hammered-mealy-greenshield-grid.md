---
layout: default
title: Four Common Bark Lichen Comparison
description: Field Notes comparing Common Greenshield, Hammered Shield, Mealy Shadow, and Powdery Shield.
---
...
<table class="table table-sm table-dark text-light text-center border-light">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Pale blue-gray to whitish</td>
      <td>Silvery gray</td>
      <td>Greenish-gray to brown-gray</td>
      <td>Pale green to yellow-green; bright when wet</td>
    </tr>

    <tr>
      <td><strong>Surface Texture</strong></td>
      <td>Dusty, powder-coated; matte</td>
      <td>Deeply cracked, “hammered metal”</td>
      <td>Fine, grainy, slightly rough</td>
      <td>Softly wrinkled; smooth to slightly glossy</td>
    </tr>

    <tr>
      <td><strong>Lobe Shape</strong></td>
      <td>Very small, rounded lobes</td>
      <td>Broad, firm lobes with sharp ridges</td>
      <td>Small lobes forming tight rosettes</td>
      <td>Broad, rounded lobes with wavy edges</td>
    </tr>

    <tr>
      <td><strong>Soredia / Reproduction</strong></td>
      <td>Abundant soredia; powdery patches</td>
      <td>Elongated pseudocyphellae & isidia</td>
      <td>Granular soredia, darker toward edges</td>
      <td>Soredia along lobe margins and ridges</td>
    </tr>

    <tr>
      <td><strong>Growth Pattern</strong></td>
      <td>Small scattered patches</td>
      <td>Large, heavy rosettes</td>
      <td>Compact circular rosettes</td>
      <td>Large, rounded foliose rosettes</td>
    </tr>

    <tr>
      <td><strong>Underside</strong></td>
      <td>Pale or whitish</td>
      <td>Black; robust dark rhizines</td>
      <td>Brown to dark with short rhizines</td>
      <td>Black with pale veins; sparse rhizines</td>
    </tr>

    <tr>
      <td><strong>Common Substrate</strong></td>
      <td>Bark (esp. conifers), occasionally rock</td>
      <td>Bark of hardwoods and conifers</td>
      <td>Hardwood bark; high sun tolerance</td>
      <td>Elm, maple, oak; prefers stable moisture</td>
    </tr>

    <tr>
      <td><strong>Field Notes</strong></td>
      <td>Looks “frosted” or lightly dusted</td>
      <td>Hammered texture is very distinctive</td>
      <td>Often mixed with Candleflame</td>
      <td>Indicator of clean air; soft green tone</td>
    </tr>
