...
layout: default
title: Sialia sialis
description: Field notes and identification details for *Sialia sialis* (Eastern Bluebird) based on observations in Minnesota.
tags: [bird, Sialia sialis, Eastern Bluebird, thrush, Turdidae, Minnesota, field-notes]
keywords: "Eastern Bluebird, Sialia sialis, Minnesota birds, bluebird identification, thrush"
---

## *Sialia sialis*
{: .taxonomy-heading}

### Family: [Turdidae](/field-notes/birds/passeriformes/turdidae/)
{: .taxonomy-heading .taxonomy-last}

[**Eastern Bluebird**](/gallery/animals/birds/perching/eastern-bluebird/) (*Sialia sialis*) is a small, upright thrush of open country, often seen perched along field edges, woodland openings, orchards, and nest-box trails. Males are bright blue above with a warm rusty-orange breast, while females show the same pattern in softer gray-blue and muted warm tones.

For representative images and visual context, see the page: [**Eastern Bluebird**](/gallery/animals/birds/perching/eastern-bluebird/) in the **Gallery** section.
