...
description: Field notes and identification details for *Cygnus buccinator* (Trumpeter Swan) based on observations in Minnesota.
tags: [bird, Cygnus buccinator, Trumpeter Swan, swan, waterfowl, Minnesota, field-notes]
...
For representative images and visual context, see the page: [**Trumpeter Swan**](/gallery/animals/birds/waterfowl/trumpeter-swan/) in the **Gallery** section.
